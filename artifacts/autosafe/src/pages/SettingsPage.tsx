  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <Alert className="border-primary/30 bg-primary/5">
        ...
        <AlertDescription className="mt-1 space-y-1 text-xs"><p>Service Data <code className="rounded bg-background px-1 border font-mono">0x2A6E</code> = temperatura int16LE÷100°C, <code className="rounded bg-background px-1 border font-mono">0x2A6F</code> = wilgotność RHT: 1 bajt procentów albo fallback uint16LE÷100.</p><p>Manufacturer Data <code className="rounded bg-background px-1 border font-mono">0x0757</code> = bateria w mV z ostatnich 2 bajtów. Czujnik nadaje dane w BLE advertising.</p></AlertDescription>
      </Alert>
    </div>
  );
}
