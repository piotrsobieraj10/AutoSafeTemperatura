// storageService.ts v5.6.1 — stabilne dane lokalne, eksport, raporty i ustawienia AutoSafe
...
export const createBackupJson = (): string => JSON.stringify({
  version: "AutoSafe_Temperatura_v5.6.1",
